...
//
//// Using the number() method in you prompts eliminates usage of loop checks.
//
////
//
//var googleHourlyPay = Number(prompt("How much does Google pay per hour?"));
//var amazonHourlyPay = Number(prompt("How much does Amazon pay per hour?"));
...
//// totalPayment += googleHourlyPay * googleHoursWorked;
//// totalPayment += amazonHourlyPay * amazonHoursWorked;
//
//
